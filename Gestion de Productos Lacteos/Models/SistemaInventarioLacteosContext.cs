...
public partial class SistemaInventarioLacteosContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DetalleCompra>(entity =>
        {
            ...
            entity.HasOne(d => d.IdCompraNavigation).WithMany(p => p.DetalleCompras).HasForeignKey(d => d.IdCompra).HasConstraintName("FK__DetalleCo__idCom__5812160E");
            entity.HasOne(d => d.IdLoteNavigation).WithMany(p => p.DetalleCompras).HasForeignKey(d => d.IdLote).HasConstraintName("FK__DetalleCo__idLot__571DF1D5");
            entity.HasOne(d => d.IdProductoNavigation).WithMany(p => p.DetalleCompras).HasForeignKey(d => d.IdProducto).HasConstraintName("FK__DetalleCo__idPro__59063A47");
        });
        ...
        modelBuilder.Entity<DetalleVenta>(entity =>
        {
            ...
            entity.Property(e => e.Precio).HasColumnType("decimal(10, 2)").HasColumnName("precio");
            entity.Property(e => e.Subtotal).HasColumnType("decimal(10, 2)").HasColumnName("subtotal");
            entity.HasOne(d => d.IdProductoNavigation).WithMany(p => p.DetalleVenta).HasForeignKey(d => d.IdProducto).HasConstraintName("FK__DetalleVe__idPro__5070F446");
            entity.HasOne(d => d.IdVentaNavigation).WithMany(p => p.DetalleVenta).HasForeignKey(d => d.IdVenta).HasConstraintName("FK__DetalleVe__idVen__4F7CD00D");
        });
        ...
        modelBuilder.Entity<Inventario>(entity =>
        {
            ...
            entity.HasOne(d => d.IdProductoNavigation).WithMany(p => p.Inventarios).HasForeignKey(d => d.IdProducto).HasConstraintName("FK__Inventari__idPro__44FF419A");
        });
        ...
        modelBuilder.Entity<Lote>(entity =>
        {
            ...
            entity.HasOne(d => d.IdProductoNavigation).WithMany(p => p.Lotes).HasForeignKey(d => d.IdProducto).HasConstraintName("FK__Lote__idProducto__4222D4EF");
        });
        ...
        modelBuilder.Entity<MovimientosInventario>(entity =>
        {
            ...
            entity.HasOne(d => d.IdProductoNavigation).WithMany(p => p.MovimientosInventarios).HasForeignKey(d => d.IdProducto).HasConstraintName("FK__Movimient__idPro__5CD6CB2B");
        });
        ...
        modelBuilder.Entity<Producto>(entity =>
        {
            ...
            // CORRECCIÓN AQUÍ: Cambiado de string a int y mapeado a la columna idCategoria
        ...
        modelBuilder.Entity<Usuario>(entity =>
        {
            ...
            entity.HasOne(d => d.IdRolNavigation).WithMany(p => p.Usuarios).HasForeignKey(d => d.IdRol).HasConstraintName("FK__Usuario__idRol__3B75D760");
        });
